...
public class MainActivityPhotoClickAndLoadTest {
    @Rule
    ...
    public void idlingResourceTest() {
            ...
            Espresso.onView(withId(R.id.recycler_view)).perform(actionOnItemAtPosition(0, click()));
            Espresso.onView(withId(R.id.iv_photo_activity)).check(matches(isDisplayed()));
